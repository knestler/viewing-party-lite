...
RSpec.describe 'Viewing Part new page' do
  before :each do
    @user1 = User.create!(name: 'Eli Fuchsman', email: 'eli@gmail.com', password: 'password123', password_confirmation: 'password123')
    @user2 = User.create!(name: 'Kristen Nestler', email: 'kristen@gmail.com', password: 'password123', password_confirmation: 'password123')
    @user3 = User.create!(name: 'John John', email: 'John@gmail.com', password: 'password123', password_confirmation: 'password123')
    @user4 = User.create!(name: 'Luke Skywalker', email: 'luke@gmail.com', password: 'password123', password_confirmation: 'password123')
    @user5 = User.create!(name: 'Michael Corleone', email: 'mike@gmail.com', password: 'password123', password_confirmation: 'password123')
    @user6 = User.create!(name: 'Tony Montana', email: 'tony@gmail.com', password: 'password123', password_confirmation: 'password123')
    @user7 = User.create!(name: 'Bruce Wayne', email: 'bruce@gmail.com', password: 'password123', password_confirmation: 'password123')
    @user8 = User.create!(name: 'Harvey Dent', email: 'harvey@gmail.com', password: 'password123', password_confirmation: 'password123')
